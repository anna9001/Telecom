...
<table>
  <tr>     
    <th align="left" style="font-size:30px; color:black;font-weight:bold">${Hmap.get('brandName')} <br/></th>
...
<div class="container">
<div class="div" style="background-color: #FFFFF0; padding:15px; text-align:center; font-weight:bold; font-size:20px; height:80px; width:80%" >
